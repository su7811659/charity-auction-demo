...
# Import all schema models to ensure they are registered with the Base
...
# Alembic Config object for reading .ini configuration
...
# If you have multiple models, use the Base.metadata from the models module
