...
const About = () => {
  ...
  const sellerSteps = [
    ...
    { url: sellerStep04, desc: t("活動當日(9/23)將你的愛心商品交給活動會場的ESG小組成員") },
  ];

  const buyerSteps = [
    { url: buyerStep01, desc: t("瀏覽商品列表並挑選你心儀的商品") },
    { url: buyerStep02, desc: t("將點擊商品頁上的愛心加入收藏") },
    { url: buyerStep03, desc: t("活動當日(9/23 的 15:00 ~ 17:30) 在活動會場中尋覓你的心儀商品並交由櫃檯的ESG小組成員進行成交") },
  ];
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, marginTop: 12 }}>
            {[
              { time: "10:00–14:30", desc: t("賣家送件至 活動會場會場") },
